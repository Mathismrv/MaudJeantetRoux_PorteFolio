...
async function openProjectModal(projectId) {
    ...
    if (project.youtube_ids && project.youtube_ids.length > 0) {
        project.youtube_ids.forEach(id => {
            content += `
    ...
    } else if (project.youtube_id) {
        content += `
            <div style="width: 100%; max-width: 900px; margin: 2rem auto; position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden;">
                <iframe 
                    src="https://www.youtube.com/embed/${project.youtube_id}?playsinline=1&rel=0" 
                    style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;" 
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                    allowfullscreen>
                </iframe>
